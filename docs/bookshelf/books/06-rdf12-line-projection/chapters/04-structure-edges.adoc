...
:heading-l41-o0 aat:childOrder 2 .
:heading-l46-o0 aat:childOrder 1 .
----
...
`aat:previousSibling` 不属于当前核心 heading projection。旧版本使用该 predicate 表达同父 sibling 链；当前契约使用 `aat:childOrder` 表达同父局部顺序，使用 `aat:documentOrder` 表达全局 preorder。
