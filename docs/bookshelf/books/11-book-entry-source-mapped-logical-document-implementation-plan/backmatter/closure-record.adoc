...
本关闭记录记录 `11-book-entry-source-mapped-logical-document-implementation-plan` 的 Batch 08 待审核关闭事实。最终通过状态由审核者写入台账。
...
[source,text]
----
- Batch 08 approval: coordinator-owned审核动作；本记录和 Batch 08 审核包保持 `待审核`。
